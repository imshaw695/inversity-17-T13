            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    ...
                    <ul class="ml-6 mt-1 space-y-1">
                        ...
                        <li>
                            <a href="#"
                                class="block p-2 text-gray-700 rounded-lg dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 text-sm">Local
                                Wind Farms Empowering Towns and Reducing Carbon
                                Footprints</a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    <a href="#"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Data Integration</span>
                    </a>
                </li>
                <li>
                    <a href="#"
